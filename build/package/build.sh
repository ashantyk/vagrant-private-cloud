...
# copy dpkg scripts
#
mkdir -p ${BASE_DST}/opt/bitdefender/var/lib/dpkg/${PACKAGE_NAME}
...
chmod +x ${BASE_DST}/opt/bitdefender/var/lib/dpkg/${PACKAGE_NAME}/*
...
# build .deb
#
sed -i "5i Installed-Size: $PACKAGE_SIZE" ${TARGET_DST}/DEBIAN/control
dpkg-deb --build ${TARGET_DST} $PACKAGE_NAME
